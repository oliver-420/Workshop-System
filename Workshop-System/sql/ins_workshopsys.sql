...
INSERT INTO TASK (NAME, START_DATE, CAR_ID)
VALUES ('Fix Motor', TO_DATE('2003/05/03 21:02:44', 'yyyy/mm/dd hh24:mi:ss'), 1);
INSERT INTO TASK (NAME, START_DATE, CAR_ID)
VALUES ('Change Oil', TO_DATE('2003/05/03 21:02:44', 'yyyy/mm/dd hh24:mi:ss'), 2);

INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Repair crankshaft', 3, 1);
INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Change piston rings', 1, 1);
INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Change oil',0.7 , 1);
INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Change oil filter', 0.1, 1);
INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Replace oil filter', 0.1, 2);
INSERT INTO SUBTASK (DESCRIPTION, DURATION, TASK_ID)
VALUES ('Fill in new oil', 0.2, 2);
